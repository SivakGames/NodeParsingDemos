...
class Parser {
	...
	parse(string) {
		...
		/**
		 * Primt tokenizer to obtain the first token which is our lookahead.
	 ...
	 *  | Additive Expression ADDITIVE_OPERATOR Literal
	 *  ;
	 */
	AdditiveExpression() {
		return this._BinaryExpression(
	...
	/**
	 * Generic helper for logical expression
	 */
	...
	PrimaryExpression() {
		...
		switch(this._lookahead.type) {
			...
			default:
				throw new SyntaxError(`Unexpected primay expression!`)
		}
	}
